...
public class SudokuSolver extends Algorithm {
	...
	public void createMainGUI() {
		...
		// Solve Time Panel -------------------------------------------------------------------------------------------------------------------------------------
		JPanel solveTimePanel = new JPanel();
		JLabel solveTime = new JLabel("Solved in ___ seconds");

		solveTimePanel.add(solveTime);
		mainPanel.add(solveTimePanel);
		// ------------------------------------------------------------------------------------------------------------------------------------------------------
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                if (!isWholeBoardValid(board)) {
                    ...
                    if (selectedAlgorithm.equals("Backtracking")) {
						...
						solvedBoard = solveWithBacktracking(board);
						long endTime = System.nanoTime();
						if (solvedBoard != null) {
							updateBoard(solvedBoard);
							double duration = (endTime - startTime) / 1000000000.0;
							solveTime.setText("Solved in " + duration + " seconds");
						}
						else {
		...
		resetButton.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				// Solve Time Stuff
				solveTime.setText("Solved in ___ seconds");
			}
		});
		// ++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
	...
	public boolean isWholeBoardValid(int[][] board) {
